...
3. במידת הצורך (ElevenLabs / Deepgram / OpenAI / ivrit.ai), הזינו את מפתח ה-API שלכם. המפתח נשמר בצורה מאובטחת בסביבת הדפדפן וזמין רק עבור הבקשות שלכם מול השרתים הרלוונטיים.
